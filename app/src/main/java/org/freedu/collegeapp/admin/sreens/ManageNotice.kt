                ...
                ElevatedCard(modifier = Modifier.padding(8.dp)) {
                    ...
                    Row {
                        Button(
                            onClick = {
                                if(imageUri == null ) {
                                    Toast.makeText(context, "Please pick a image", Toast.LENGTH_SHORT).show()
                                }else if(title == ""){
                                    Toast.makeText(context, "Please fill title field", Toast.LENGTH_SHORT).show()
                                }else
